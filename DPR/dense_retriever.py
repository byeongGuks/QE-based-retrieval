...
def generate_question_vectors(
    ...
    with torch.no_grad():
        for j, batch_start in enumerate(range(0, n, bsz)):
            ...
            max_vector_len = max(q_t.size(0) for q_t in batch_tensors) ## modify by BK https://github.com/facebookresearch/DPR/issues/213
...
def main(cfg: DictConfig):
    ...
    for i in range(total_queries):
        ...
        if i%100==0 :
            print(i)
        question = query_expansion_model.generate_one(question)
        ###
